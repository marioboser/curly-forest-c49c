...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/curly-forest-c49c
```

A live public deployment of this template is available at [https://curly-forest-c49c.templates.workers.dev](https://curly-forest-c49c.templates.workers.dev)
